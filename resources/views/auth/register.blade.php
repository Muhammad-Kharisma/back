            ...
            <div class="p-5">
              ...
              <form class="user" action="{{ route('register') }}" method="POST">
                ...
                <div class="form-group">
                  <input  type="text" class="form-control form-control-user{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus id="exampleFirstName" placeholder="Full Name" >
