    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="home">
        <div class="sidebar-brand-icon">
          ...
          <img src="css_admin/img/DE abu.png">
        </div>
        <div class="sidebar-brand-text mx-3">D U N I A - E L E K T R O N I K<sup></sup></div>
      </a>
        ...
        <li class="nav-item">
          ...
          <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="kategori">Data Katagori</a>
              <a class="collapse-item" href="produks">Data Produks</a>
              <a class="collapse-item" href="konsumen">Data Konsumen</a>
              <a class="collapse-item" href="penjualan">Data Penjualan</a>
            </div>
          </div>
        </li>
